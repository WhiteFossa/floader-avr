...
/* Версия 0.0.3 (порт) от 05.09.2012                                             */
/* Порт для ATMega168                                                            */
...
.equ		LED_BIT			=		0						//Какой бит выставлять в 1

.equ		OSC_FREQ		=		2048000					//Частота кварца
...
cbi			LED_DDR,		LED_BIT
cbi			LISTEN_PORT,	LISTEN_BIT							//Выключаем подтягивающий резистор
