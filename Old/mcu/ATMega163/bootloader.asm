...
//МК-специфические дефайны (ATmega163)
...
//Завершение прошивки
QUIT:
//Восстанавливаем доступ к области основной программы
ldi			R16,			(1<<ASRE)|(1<<SPMEN)
call		MAKE_SPM

//Ждём сбрасывания ASB (доступ к области основной программы разрешен)
ASB_WAIT:
in			R16,			SPMCR
sbrc		R16,			ASB
rjmp		ASB_WAIT
